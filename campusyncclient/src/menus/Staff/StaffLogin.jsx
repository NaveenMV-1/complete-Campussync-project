          ...
          <div className="card border-0 shadow-sm p-4">
            <div className="card-body">
              ...
              <div className="d-flex align-items-center gap-3 mb-4">
                ...
                <div>
                  <h2 className="h4 mb-0 fw-bold">Faculty Login</h2>
              ...
              <form onSubmit={handleLogin}>
                <div className="mb-3">
                  ...
                  <input
                    ...
                    placeholder="e.g. EMP109 or email@college.edu"
                    value={identifier}
              ...
              <div className="text-center mt-3">
                ...
                <Link to="/staff/signup" className="text-primary small fw-bold text-decoration-none">
                  Sign Up
                </Link>
              </div>
