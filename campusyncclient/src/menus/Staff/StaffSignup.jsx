          ...
          <div className="card border-0 shadow-sm p-4">
            <div className="card-body">
              ...
              <div className="d-flex align-items-center gap-3 mb-4">
                ...
                <div>
                  <h2 className="h4 mb-0 fw-bold">Faculty Signup</h2>
              ...
              <form onSubmit={handleSignup}>
                ...
                <div className="row mb-3">
                  <div className="col-md-6">
                    ...
                    <input type="text" className="form-control" name="employee_id" onChange={handleChange} required />
                  </div>
                  <div className="col-md-6">
              ...
              <div className="text-center mt-3">
                ...
                <Link to="/staff/login" className="text-primary small fw-bold text-decoration-none">
                  Sign In
                </Link>
              </div>
